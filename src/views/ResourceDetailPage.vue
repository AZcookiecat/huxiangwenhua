        ...
        <div class="resource-main">
          ...
          <div class="resource-gallery">
            <div class="gallery-main">
              <img :src="currentImage" :alt="resource.title" class="main-image" />
            </div>
            <div class="gallery-thumbs" v-if="resource.images && resource.images.length > 1">
              ...
              >
                <img :src="img" :alt="`${resource.title} ${index + 1}`" />
              </div>
            </div>
          </div>
          ...
          <div class="resource-detail-content">
            ...
            <div class="content-paragraph" v-for="(paragraph, index) in detailParagraphs" :key="index">
              ...
              <img v-if="paragraph.image" :src="paragraph.image" :alt="paragraph.title" class="content-image" />
            </div>
          </div>
          ...
          <div class="contributor-card">
            ...
            <div class="contributor-info">
              <div class="contributor-avatar">
                <img :src="resource.contributorAvatar" :alt="resource.contributorName" />
              </div>
